...
TEMPLATES: dict[str, SubtitleTemplate] = {
    ...
    # --- 5 new templates (Phase 2 completion) ---

    "most_readable": SubtitleTemplate(
        name="most_readable",
        description="Dễ đọc nhất — chữ vàng đậm trên nền đen, mobile-first",
        font_size=42,
        font_color="#FFD700",
        font_bold=True,
        bg_enabled=True,
    ...
    "the_fancy": SubtitleTemplate(
        name="the_fancy",
        description="Sang trọng — chữ nghiêng trắng trên gradient xám nhẹ",
        font_size=36,
        font_color="#FAFAFA",
        font_bold=False,
        bg_enabled=True,
    ...
    "the_eccentric": SubtitleTemplate(
        name="the_eccentric",
        description="Cá tính — chữ xanh dương đậm với highlight radial",
        font_size=40,
        font_color="#3B82F6",
        font_bold=True,
        bg_enabled=True,
    ...
    "gen_z_bold": SubtitleTemplate(
        name="gen_z_bold",
        description="Gen Z — chữ to đậm hồng-tím, viền mạnh, TikTok viral",
        font_size=48,
        font_color="#FF69B4",
        font_bold=True,
        bg_enabled=False,
        outline_enabled=True,
        outline_color="#2D0A3E",
        outline_width=5,
        shadow_enabled=True,
        shadow_color="#FF69B450",
        shadow_offset_x=3,
        shadow_offset_y=3,
        position_bottom_pct=35.0,
        max_chars_per_line=16,
    ),

    "poetry_script": SubtitleTemplate(
        name="poetry_script",
        description="Thơ/Trích dẫn — chữ thanh thoát, nền mờ tối, giữa màn hình",
        font_size=32,
        font_color="#E8D5B7",
        font_bold=False,
        bg_enabled=True,
